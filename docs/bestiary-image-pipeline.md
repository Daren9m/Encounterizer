...
Batch comparison grids are stored beside their review packets as `docs/visual-review/<batch-id>-contact-sheet.webp`. The current grids are `pilot-contact-sheet.webp`, `production-01-contact-sheet.webp`, and `production-02-contact-sheet.webp`.
