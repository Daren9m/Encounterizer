...
export default function CreditsPage() {
  return (
    <div className="animate-fade-in max-w-3xl mx-auto space-y-6">
      <h1 className="text-3xl font-bold text-[var(--gold)]">Credits &amp; Licensing</h1>

      <section className="card space-y-3">
        <h2 className="text-xl font-bold text-[var(--gold)]">Game Content</h2>
        <p>
      ...
      <section className="card space-y-3">
        <h2 className="text-xl font-bold text-[var(--gold)]">Unofficial Content</h2>
        <p className="text-sm">
      ...
      <section className="card space-y-3">
        <h2 className="text-xl font-bold text-[var(--gold)]">Application</h2>
        <p className="text-sm">
