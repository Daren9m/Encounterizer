...
export const GAUNTLET_HAZARDS: GauntletHazard[] = [
  ...
  { name: 'The Gas Vault', hazard: 'a hissing vent fills the room with sickly green vapor, thicker with every round', felt: 'a sickly green haze thickens with every breath you spend inside it', escape: 'seal the vent and force the door before the air turns fatal', omen: 'the vapor pours thickest from a single hissing vent near the floor', skills: ['Constitution', 'Investigation'] },
  { name: 'The Freezing Vault', hazard: 'the air bites colder every round as frost creeps up the walls and seals the seams', felt: 'the cold deepens until breath crackles and frost welds the seams shut', escape: 'light the brazier chain before the frost welds the exit shut', omen: 'along one wall, a chain of cold braziers stands waiting, wicks still tarred', skills: ['Constitution', 'Survival', 'Sleight of Hand'] },
  { name: 'The Gravity Well', hazard: 'the pull shifts a quarter-turn each round, dragging loose gear and footing with it', felt: 'up keeps changing its mind, dragging loose gear and footing sideways', escape: 'reach the anchor stone and brace it before the room fully inverts', omen: 'one block of the floor never shifts — a single stone the pull cannot touch', skills: ['Acrobatics', 'Athletics'] },
  { name: 'The Sand Cascade', hazard: 'sand pours from cracks in the ceiling, burying the floor a little deeper each round', felt: 'the ceiling sifts itself onto your boots, dry and endless, burying the floor by inches', escape: 'clear the sluice grate before the chamber fills to the rafters', omen: 'beneath the pouring sand, something metal rattles — a grate, half-buried', skills: ['Athletics', 'Investigation'] },
  { name: 'The Pendulum Hall', hazard: 'a bank of scythed pendulums swings lower and faster with every round', felt: 'scythes sweep the hall in quickening arcs, each pass lower than the last', escape: 'time a dash to the far lever and haul it before being caught mid-swing', omen: 'past the swinging blades, at the far end, a lever juts from the wall', skills: ['Acrobatics', 'Perception'] },
  ...
  { name: 'The Rising Current', hazard: 'a live current runs through the rising water, growing stronger and colder each round', felt: 'the rising water bites with a lightning sting that grows crueler as it climbs', escape: 'rope off to the anchor ring and crank the sluice shut', omen: 'an iron ring is set into the wall above the waterline, rope-worn smooth', skills: ['Athletics', 'Investigation'] },
  ...
  { name: 'The Spike Floor', hazard: 'iron spikes punch up through more of the floor with every round, the safe path narrowing', felt: 'iron points punch up through the flagstones, the safe path narrowing with every step', escape: 'reach the control plinth and reverse the mechanism', omen: 'on a raised plinth across the hall, something clicks in time with the spikes', skills: ['Acrobatics', 'Perception'] },
];
